    ...
    return (
        <>
            ...
            <section className='social'>
                ...
                <a rel="noreferrer" target="_blank" href="https://github.com/mrivera0014"><FaIcons.FaGithub />Github</a>
                <a rel="noreferrer" target="_blank" href="https://www.linkedin.com/in/marblerivera/"><FaIcons.FaLinkedin />LinkedIn</a>
                <a rel='noreferrer' target='_blank' href='https://drive.google.com/file/d/1I6XwAcUdvy6ffTu0i8RX97pFKnF0LRME/view?usp=sharing'><button>Resume</button></a>
            </section>
        </>
    )
}
